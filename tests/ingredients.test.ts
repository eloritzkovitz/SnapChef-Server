...
import ingredientController from "../src/modules/ingredients/ingredientController";
import * as ingredientService from "../src/modules/ingredients/ingredientService";
...
jest.mock("../src/modules/ingredients/ingredientService", () => ({
