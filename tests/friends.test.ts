...
import FriendRequest from "../src/modules/users/FriendRequest";
import * as firebaseMessaging from "../src/utils/firebaseMessaging";
import { io } from "../src/server";
import * as userUtils from "../src/modules/users/userUtils";
import friendsRoutes from "../src/modules/users/friendsRoutes";
...
jest.mock("../src/modules/users/FriendRequest");
jest.mock("../src/utils/firebaseMessaging");
